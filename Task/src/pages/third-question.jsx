    ...
    <>
      <div className="container">
        ...
        <div className="answers-container">
          <button
            onClick={() => handleAnswer("Anti-breakage")}
            className="answer"
          >
          ...
          <button
            onClick={() => handleAnswer("Soothing dry scalp")}
            className="answer"
          >
            <span className="answer-text">c. Soothing dry scalp</span>
          </button>
          <button
            onClick={() => handleAnswer("Repairs appearance of damaged hair")}
            className="answer"
          >
          ...
          <button
            onClick={() => handleAnswer("Curl and coil enhancing")}
            className="answer"
          >
        ...
        <div className="next-back">
          <a href="/second" className="back-link">
            Back
          </a>
